...
const styles: Record<string, React.CSSProperties> = {
  ...
  logoutBtn: {
    ...
    padding: '10px 14px',
    backgroundColor: 'transparent',
    border: '1.5px solid rgba(139, 30, 30, 0.45)',
    borderRadius: 10,
    color: '#8B1E1E',
    fontSize: 13,
    fontWeight: 600,
      ...
      <div style={styles.body}>
        ...
        <div style={styles.bottomNavSection}>
          ...
          <button style={styles.logoutBtn} onClick={handleLogout}>
            <span>Log Out</span>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#8B1E1E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
